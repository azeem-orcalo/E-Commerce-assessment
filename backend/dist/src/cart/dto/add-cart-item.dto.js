...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Colour variant selected on the product page' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_transformer_1.Transform)(({ value }) => typeof value === 'string' ? value.trim() : ''),
    __metadata("design:type", String)
], AddCartItemDto.prototype, "chosenColor", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Size variant selected on the product page' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_transformer_1.Transform)(({ value }) => typeof value === 'string' ? value.trim() : ''),
    __metadata("design:type", String)
], AddCartItemDto.prototype, "chosenSize", void 0);

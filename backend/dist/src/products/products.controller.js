...
__decorate([
    ...
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List products — search, category filter, sort, paginate' }),
...
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Single product detail with variants and stock' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Soft-delete a product (Admin only)' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
